...
1. login 하기
    ...
    - <사용자ID>
      ...
      간단히 _jonggyou.kim@oracle.com_ 으로 나타나지 않고 _oracleidentitycloudservice/jonggyou.kim@oracle.com_ 로 나타나는 이유는 Oracle Identity Cloud Service 에서 연합되었기 때문입니다. 5
